...
// Clase encargada del menu principal del juego.
public class PantallaMenu implements Screen
{
    ...
    public PantallaMenu(final MainGame juego) // Constructor de la pantalla menu
    {
        ...
        fondoPantallaMenus = juego.getAdminComponentes().get("Imagenes/backgroundMenus.png", Texture.class); // Ahora, cargamos el fondo para este menu
        ...
        skinMenu = new Skin(Gdx.files.internal("Skin/uiskin.json"));
        ...
        organizadorMenu.row();
        organizadorMenu.add(botonJugar).width(juego.ANCHO_VIRTUAL/4).height(juego.ALTO_VIRTUAL/8);
        organizadorMenu.row();
        organizadorMenu.add(botonOpciones).width(juego.ANCHO_VIRTUAL/4).height(juego.ALTO_VIRTUAL/8);
        organizadorMenu.row();
        organizadorMenu.add(botonSalir).width(juego.ANCHO_VIRTUAL/4).height(juego.ALTO_VIRTUAL/8);
        ...
        vistaMenu = new FitViewport(juego.ANCHO_VIRTUAL, juego.ALTO_VIRTUAL, camara); // Por ultimo, se inicializa la vista con unas dimensiones tentativas de 1280x720.
    }
    ...
    public void render(float delta)
    {
        ...
        juego.dibujadorPantalla.draw(fondoPantallaMenus, 0, 0,juego.ANCHO_VIRTUAL, juego.ALTO_VIRTUAL); // Aqui se dibuja el fondo y se ajusta a las dimensiones dadas
