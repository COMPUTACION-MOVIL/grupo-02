...
public class PantallaCarga implements Screen
{
    ...
    public PantallaCarga(final MainGame juego) // Constructor de la pantalla de carga
    {
        ...
        escenarioCarga = new Stage(new FitViewport(juego.ANCHO_VIRTUAL, juego.ALTO_VIRTUAL));
        skinCarga = new Skin(Gdx.files.internal("Skin/uiskin.json"));
        etiquetaProgesoCarga = new Label("Cargando...", skinCarga);
        etiquetaProgesoCarga.setPosition(((juego.ANCHO_VIRTUAL/2)-(etiquetaProgesoCarga.getWidth()/2)), ((juego.ALTO_VIRTUAL/2)-(etiquetaProgesoCarga.getHeight()/2)));
