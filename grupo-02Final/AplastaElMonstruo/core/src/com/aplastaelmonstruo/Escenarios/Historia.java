    ...
    public Historia (final MainGame juego, int nivel) // Constructor de la pantalla de juego
    {
        ...
        switch (nivel)
        {
            ...
            case(3):
                ...
                {
                    enemigos.add(new Monstruo(MathUtils.random(0, MainGame.ANCHO_VIRTUAL), MathUtils.random(0, MainGame.ALTO_VIRTUAL), MathUtils.random(3,5), false));
                }
                break;
            case(4):
            case(5):
            ...
            case(7):
                for (int i = 0; i < nivel*10; i++)
                {
                    enemigos.add(new Monstruo(MathUtils.random(0, MainGame.ANCHO_VIRTUAL), MathUtils.random(0, MainGame.ALTO_VIRTUAL), MathUtils.random(2,5), false));
                }
                break;
            case(8):
            case(9):
            case(10):
                for (int i = 0; i < nivel*10; i++)
                {
                    enemigos.add(new Monstruo(MathUtils.random(0, MainGame.ANCHO_VIRTUAL), MathUtils.random(0, MainGame.ALTO_VIRTUAL), MathUtils.random(1,5), false));
                }
                break;
        }
